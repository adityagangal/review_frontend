...
const APILINK = 'localhost/8000/api/v1/reviews/';
  ...
  <div class="row">
    <div class="column">
      <div class="card">
          ...
          <input type="text" id="new_rating" value="">
          </p>
...
function saveReview(reviewInputId, userInputId,ratingInputId, id="") {
  ...
  if (id) {
    ...
    fetch(APILINK + "new", {
      ...
      body: JSON.stringify({"user": user, "review": review, "rating": rating, "movieId": movieId})
    }).then(res => res.json())
      .then(res => {
        console.log(res)
        location.reload();
